<h1 align="center">Casper-C</h1>

<p align="center">A custom implementation of the Casper theme for use on my personal blog<br>@<a href="https://jector.io/">jector.io</a></p>
...
3. Add custom socials in header in `default.hbs`
4. Add `Releases` button
5. Change `screens.css`
   - Round off featured image borders
6. Add subscribe buttons in footer
7. Custom powered by message "Powered by No Coffee"
